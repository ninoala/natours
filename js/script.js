//'discover our tours' button scrolling smoothly to a section on the page
document.getElementById('scroll-to-tours-btn').addEventListener('click', () => {
  document.getElementById('section-tours').scrollIntoView({ behavior: 'smooth' });
})

//display a popup with explanation for the buttons/links on the page
